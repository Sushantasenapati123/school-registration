...
select * from TblSchoolRegistration
Create Table TblState
(
StateID int Primary Key Identity(1,1),
StateName Varchar(50)
);
insert into TblState values('Odisha'),('Bihar')
...
insert into TblDistrict values(1,'Mayurbhanj'),(1,'Khordha')
insert into TblDistrict values(2,'patna'),(2,'patna2')
